...
public class Science extends AppCompatActivity {
    private final String recyclerViewTitleText[] = {"About", "Events", "contact", "GridView", "ListView", "Tutorial", "Example", "CardView", "Lollipop", "Marshmallow", "Custom ListView", "Custom GridView"
    };

    private final int recyclerViewImages[] = {
            R.drawable.model1, R.drawable.model2, R.drawable.model3, R.drawable.model4, R.drawable.model5, R.drawable.model2,
            R.drawable.model2, R.drawable.model2, R.drawable.model2, R.drawable.model2, R.drawable.model2, R.drawable.model2
